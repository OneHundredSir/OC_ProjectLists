...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _BorrowsucceedLabel.textColor = BrownColor;
        ...
        _BorrowfailLabel.textColor = BrownColor;
        ...
        _repaymentnormalLabel.textColor = BrownColor;
        ...
        _repaymentabnormalLabel.textColor = BrownColor;
        ...
        _MailBtn.frame = CGRectMake(250, 5, 30, 30);
