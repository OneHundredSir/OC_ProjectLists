...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _dateTime = [[UILabel alloc] initWithFrame:CGRectMake(self.frame.size.width - 170, 8, 150, 20)];
        ...
        _more = [UIButton buttonWithType:UIButtonTypeRoundedRect];
        _more.frame = CGRectMake(self.frame.size.width - 20 - 30, 36, 28, 28);
//        [_more setBackgroundImage:[UIImage imageNamed:@"tab_transfer"] forState:UIControlStateNormal];
