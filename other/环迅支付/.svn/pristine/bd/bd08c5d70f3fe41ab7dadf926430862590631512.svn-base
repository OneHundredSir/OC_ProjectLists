...
@property(nonatomic, strong) UILabel *availabelLabel;
...
//    [self hiddenRefreshView];
    ...
    if ([[NSString stringWithFormat:@"%@",[dics objectForKey:@"error"]] isEqualToString:@"-1"]) {
        ...
        _availabelLabel.text = [NSString stringWithFormat:@"%.2f",[[dics objectForKey:@"balance"] floatValue]];

         _amountLabel.text = [NSString stringWithFormat:@"%.2f",[[dics objectForKey:@"amount"] floatValue]];
         _repayLabel.text = [NSString stringWithFormat:@"%.2f",[[dics objectForKey:@"back_amount"] floatValue]];
         _receivableLabel.text = [NSString stringWithFormat:@"%.2f",[[dics objectForKey:@"repay_amount"] floatValue]];
         _freeZingLabel.text = [NSString stringWithFormat:@"%.2f",[[dics objectForKey:@"frozen_amount"] floatValue]];
        _profitLabel.text =
        ...
        NSString *numberString = [numberFormatter stringFromNumber: [NSNumber numberWithFloat:[[dics objectForKey:@"sum_income"] floatValue]]];
        NSString *numberString2 = [NSString stringWithFormat:@"%.2f",[[dics objectForKey:@"sum_income"] floatValue]];
        NSString *subStr = [numberString2 substringWithRange:NSMakeRange(numberString2.length - 3, 3)];
        _profitLabel.text = [NSString stringWithFormat:@"%@%@",numberString,subStr];
