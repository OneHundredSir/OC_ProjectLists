...
- (void)initView
{
    ...
    UILabel  *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 130, self.view.frame.size.width-20, 30)];
    ...
    _reasonView  = [[UITextView alloc]  initWithFrame:CGRectMake(10, 135, self.view.frame.size.width-20, 80)];
