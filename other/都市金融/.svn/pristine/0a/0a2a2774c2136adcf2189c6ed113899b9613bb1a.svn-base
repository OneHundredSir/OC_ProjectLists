...
- (void)initView
{
    ...
    UILabel *titleLabel = [[UILabel alloc]  initWithFrame:CGRectMake(10, titleLabelY, 120, 30)];
    ...
    CGFloat _questionViewY = titleLabelY + 35;
    _questionView = [[UITextView alloc] initWithFrame:CGRectMake(10, _questionViewY, self.view.frame.size.width-20, 80)];
    ...
    _questionView.font = [UIFont systemFontOfSize:14.0];
    _questionView.backgroundColor= [UIColor whiteColor];
    [self.view addSubview:_questionView];

     CGFloat askBtnY = _questionViewY + 135;
    UIButton *askBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    askBtn.frame = CGRectMake(self.view.frame.size.width*0.5-50, askBtnY,100, 30);
