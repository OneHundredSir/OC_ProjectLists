...
- (void)initView
{
    ...
    for (int i = 0; i<3; i++) {
        ...
        UILabel *textlabel = [[UILabel alloc] initWithFrame:CGRectMake(15, 120+80*i, 150, 30)];
...
//    [self.view addSubview:answerlabel1];
//    
...
//    [self.view addSubview:answerlabel2];
//    
...
//    [self.view addSubview:answerlabel3];
