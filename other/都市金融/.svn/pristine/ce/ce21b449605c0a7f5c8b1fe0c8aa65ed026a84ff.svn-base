...
- (void)initView
{
    ...
    CGFloat _idLabelX = 18.f;
    CGFloat _idLabelW = 60.f;
    _idLabel = [[UILabel alloc] initWithFrame:CGRectMake(_idLabelX, _idLabelX - 8, _idLabelW, 25)];
//    _idLabel.text =  [NSString stringWithFormat:@"Z%@",_creditorId];
    ...
    _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(_idLabelW + _idLabelX + 5,  _idLabelX - 8, MSWIDTH-90, 25)];
...
//    _collectBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    ...
    //待收本金
    CGFloat _textLabel1X = 15.f;
    CGFloat _textLabel1H = 30.f;
    CGFloat _textLabel1W = 70.f;
    _textLabel1 = [[UILabel alloc] initWithFrame:CGRectMake(_textLabel1X, 30, _textLabel1W, _textLabel1H)];
    ...
    //拍卖底价
    _textLabel2 = [[UILabel alloc] initWithFrame:CGRectMake(_textLabel1X, 55, _textLabel1W, _textLabel1H)];
    ...
    // 目前拍价
    _textLabel3 = [[UILabel alloc] initWithFrame:CGRectMake(_textLabel1X, 80, _textLabel1W, _textLabel1H)];
    _textLabel3.font = [UIFont systemFontOfSize:13.0f];
    _textLabel3.text = @"目前拍价:";
    _textLabel3.textAlignment = NSTextAlignmentLeft;
    [_ScrollView addSubview:_textLabel3];
    
    CGFloat _moneyLabel1X = CGRectGetMaxX(_textLabel1.frame);
    CGFloat _moneyLabel1W = self.view.bounds.size.width - _moneyLabel1X - 20;
    _moneyLabel1 = [[UILabel alloc] initWithFrame:CGRectMake(_moneyLabel1X, 30, _moneyLabel1W, _textLabel1H)];
    _moneyLabel1.textColor = [UIColor grayColor];
    _moneyLabel1.font = [UIFont systemFontOfSize:12.0f];
    [_ScrollView addSubview:_moneyLabel1];
    
    _moneyLabel2 = [[UILabel alloc] initWithFrame:CGRectMake(_moneyLabel1X, 55, _moneyLabel1W, _textLabel1H)];
    _moneyLabel2.textColor = [UIColor  grayColor];
    _moneyLabel2.font = [UIFont systemFontOfSize:12.0f];
    [_ScrollView addSubview:_moneyLabel2];
    
    _moneyLabel3 = [[UILabel alloc] initWithFrame:CGRectMake(_moneyLabel1X, 80, _moneyLabel1W, _textLabel1H)];
    _moneyLabel3.textColor = [UIColor grayColor];
    _moneyLabel3.font = [UIFont systemFontOfSize:12.0f];
    [_ScrollView addSubview:_moneyLabel3];
    
    // 竞拍状态 ,add
    CGFloat _stateLabelY = CGRectGetMaxY(_textLabel3.frame);
    _stateLabel = [[UILabel alloc] initWithFrame:CGRectMake(_textLabel1X, _stateLabelY, _textLabel1W - 10, _textLabel1H)];
    _stateLabel.textColor = [UIColor whiteColor];
    _stateLabel.backgroundColor = kAttentionColor;
...
//    _dateBackView = [[UIView alloc] initWithFrame:CGRectMake(10, 90, 110, 30)];
...
//    _dateLabel1 = [[UILabel alloc] initWithFrame:CGRectMake(50, 90, 110, 30)];
...
//    _clockimg = [[UIImageView alloc] initWithFrame:CGRectMake(20, 95, 22, 22)];
    _clockimg.image = [UIImage imageNamed:@"clock_big"];
    _clockimg.backgroundColor = [UIColor clearColor];
    [_ScrollView addSubview:_clockimg];
    
    
    _dateLabel2 = [[UILabel alloc] initWithFrame:CGRectMake(_moneyLabel1X, _stateLabelY, 170, _textLabel1H)];
    _dateLabel2.textColor = [UIColor whiteColor];
    _dateLabel2.backgroundColor = SETCOLOR(229, 59, 80, 1);
    ...
    _detailView = [[UITextView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_dateLabel2.frame)+10, MSWIDTH, 50)];
    _detailView.textColor = [UIColor lightGrayColor];
    _detailView.font = [UIFont boldSystemFontOfSize:13.0f];
    _detailView.userInteractionEnabled = NO;
    _detailView.contentInset = UIEdgeInsetsMake(0, 10, 0, 10);
    _detailView.textAlignment = NSTextAlignmentLeft;
    _detailView.backgroundColor = [UIColor whiteColor];
    [_ScrollView addSubview:_detailView];
    
    
     _listView = [[UIFolderTableView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_detailView.frame)+10, MSWIDTH, 840)  style:UITableViewStyleGrouped];
    ...
    CGFloat _bottomViewH = 74.f;
    CGFloat _bottomViewLeading = 10;
    _bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - _bottomViewH - 49, MSWIDTH, _bottomViewH)];
    ...
    auctionBtn.frame = CGRectMake(_bottomViewLeading, _bottomViewLeading/2,MSWIDTH - 2*_bottomViewLeading, 49);
    auctionBtn.backgroundColor = KColor;
    auctionBtn.layer.cornerRadius = 6.f;
    auctionBtn.layer.masksToBounds = YES;
    [auctionBtn setTitle:@"立即竞拍" forState:UIControlStateNormal];
...
-(void) httpResponseSuccess:(NetWorkClient *)client dataTask:(NSURLSessionDataTask *)task didSuccessWithObject:(id)obj
{
    ...
    if ([[NSString stringWithFormat:@"%@",[dics objectForKey:@"error"]] isEqualToString:@"-1"]) {
        ...
        if (_num == 1) {
            ...
            _moneyLabel1.text = [NSString stringWithFormat:@"¥ %.2f",[dics[@"principal"] doubleValue]];//待收本金
            _moneyLabel2.text = [NSString stringWithFormat:@"¥ %.2f",[dics[@"auctionBasePrice"] doubleValue]];//拍卖底价
            _moneyLabel3.text = [NSString stringWithFormat:@"¥ %.2f",[dics[@"maxOfferPrice"] doubleValue]];//目前拍价
            _idLabel.text =  [NSString stringWithFormat:@"编号：%@",[dics objectForKey:@"debtNo"]];   // 编号
            debtNo = [NSString stringWithFormat:@"%@",[dics objectForKey:@"debtNo"]];
            // 编号
            ...
            CGSize labelSize = [_detailView.text boundingRectWithSize:CGSizeMake(MSWIDTH, 2000) options:NSStringDrawingUsesLineFragmentOrigin attributes:attributes context:nil].size;
            CGFloat labelHeight = labelSize.height+25;
            
            _detailView.frame = CGRectMake(0, _detailView.frame.origin.y, MSWIDTH, 50 < labelHeight?labelHeight:50);
            
            
            _listView.frame = CGRectMake(0, CGRectGetMaxY(_detailView.frame)+10, MSWIDTH, 840);
            
            _ScrollView.contentSize = CGSizeMake(self.view.frame.size.width, CGRectGetMaxY(_listView.frame)+30);
...
//                DLOG( @"%@", [responseObject JSONString]);
                ...
                if ([responseObject[@"error"] intValue] == -1) {
                    ...
                    if ([[responseObject allKeys] containsObject:@"businessLicense"]) { //企业
                        ...
                        [self.navigationController pushViewController:BorrowerInfoView animated:YES];
                    }
...
//        NSString *imagePath = [[NSBundle mainBundle] pathForResource:@"logo" ofType:@"png"];
        ...
        //构造分享内容
        id<ISSContent> publishContent = [ShareSDK content:@"sp2p 7.1.2晓风网贷 债权标详情"
                                           defaultContent:@"默认分享内容，没内容时显示"
                                                    image:[ShareSDK pngImageWithImage:[UIImage imageNamed:@"logo"]]
                                                    title:@"sp2p 7.1.2晓风网贷 债权标"
                                                      url:shareUrl
                                              description:@"债权详情"
...
- (void)timeDown:(NSString *)timeStr
{
    ...
    if (days <= 0&&hours <= 0&&minute <= 0&&seconds<=0)
    {
        ...
        _detailView.frame = CGRectMake(0, CGRectGetMinY(_dateLabel2.frame), MSWIDTH, _detailView.frame.size.height);
        
        _listView.frame = CGRectMake(0, CGRectGetMaxY(_detailView.frame)+10, MSWIDTH, 800);
