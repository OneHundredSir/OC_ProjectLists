...
- (void)initView
{
    ...
    _transferReason.frame = CGRectMake(80, 261, MSWIDTH-120, 21);
...
-(void) httpResponseSuccess:(NetWorkClient *)client dataTask:(NSURLSessionDataTask *)task didSuccessWithObject:(id)obj
{
    ...
    if ([[NSString stringWithFormat:@"%@",[dics objectForKey:@"error"]] isEqualToString:@"-1"]) {
        ...
        _receiveCorpus.text =  [obj objectForKey:@"receiveCorpus"];
        ...
        _transferReason.frame =  CGRectMake(80, 261, MSWIDTH-120, LabelSiZe.height);
