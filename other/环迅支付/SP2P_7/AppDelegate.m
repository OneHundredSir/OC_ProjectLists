...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [ShareSDK connectWeChatWithAppId:@"wx508c03356371a784"
...
-(void) httpResponseSuccess:(NetWorkClient *)client dataTask:(NSURLSessionDataTask *)task didSuccessWithObject:(id)obj
{
    ...
    if ([[NSString stringWithFormat:@"%@",[dics objectForKey:@"error"]] isEqualToString:@"-1"]) {
        ...
        if (![[dics objectForKey:@"fileNames"] isEqual:[NSNull null]]&& [dics objectForKey:@"fileNames"]!= nil) {
            ...
            if ([[dics objectForKey:@"fileNames"] count] != 0) {
                if ([[dics objectForKey:@"fileNames"][0] hasPrefix:@"http"]) {
                    imageUrl = [NSString stringWithFormat:@"%@", [dics objectForKey:@"fileNames"][0]];
                }else{
                    imageUrl = [NSString stringWithFormat:@"%@%@", Baseurl, [dics objectForKey:@"fileNames"][0]];
                }
