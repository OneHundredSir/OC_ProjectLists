...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UITableViewCell *cell = (UITableViewCell *)[folderTableView cellForRowAtIndexPath:indexPath];
...
- (void)expandBtnClick:(UIButton *)btn
{
    ...
    if (expandClicked) {
        ...
        if (collection.transferStatus == -1 || collection.transferStatus == 1) {
            ...
            _backview.frame = CGRectMake(cell1.frame.size.width - 65, 49.5, 60, 30);
            ...
            _backview.frame = CGRectMake(cell1.frame.size.width - 65, 49.5, 60, 59);
        ...
        if (btn.tag == 0) {
            ...
            if (collection.transferStatus == -1 || collection.transferStatus == 1) {
                ...
                _backview.frame = CGRectMake(cell1.frame.size.width - 65, 49.5 + (btn.tag * 70) - (btn.tag * 1), 60, 30);
                
            }else {
                _backview.frame = CGRectMake(cell1.frame.size.width - 65, 49.5 + (btn.tag * 70) - (btn.tag * 1), 60, 59);
            }
        }
