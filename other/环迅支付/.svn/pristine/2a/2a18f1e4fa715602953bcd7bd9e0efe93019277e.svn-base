...
//                _listView.frame = CGRectMake(0, 150, self.view.frame.size.width, 800);
            ...
            [_borrowRecordStr addAttribute:NSForegroundColorAttributeName value:GreenColor range:NSMakeRange(6,nameLen)];
            [_borrowRecordStr addAttribute:NSForegroundColorAttributeName value:GreenColor range:NSMakeRange(nameLen+12,amountLen)];
            ...
            [_repayRecordStr addAttribute:NSForegroundColorAttributeName value:GreenColor range:NSMakeRange(6,fristLen)];
            [_repayRecordStr addAttribute:NSForegroundColorAttributeName value:GreenColor range:NSMakeRange(fristLen+12,secondLen)];
