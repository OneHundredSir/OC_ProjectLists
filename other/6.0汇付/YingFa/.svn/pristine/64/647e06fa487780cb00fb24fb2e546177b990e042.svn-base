//
//  AuditingDebtViewController.m
//  SP2P_6.1
//
//  Created by Jerry on 14-8-2.
//  Copyright (c) 2014年 EIMS. All rights reserved.
//
//  账户中心 -> 理财子账户 -> 债权管理(转让债权管理) -> 审核中
...
@interface AuditingDebtViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation AuditingDebtViewController
...
- (void)initView
{
    ...
    titleLabel.text = @"此债权正在审核中,请耐心等候。";
