...
@interface CreditScreenViewController ()<UITableViewDataSource,UITableViewDelegate,SKSTableViewDelegate>
{
...
- (void)didSelectedCheckBox:(QCheckBox *)checkbox checked:(BOOL)checked
{
    ...
    DLOG(@"did tap on CheckBox:%ld checked:%ld", (long)checkbox.tag, (long)checked);
        ...
        switch (checkbox.tag) {
            ...
            case 201:
            {
                ...
                for (int i = 0; i<[ScreenArr count]; i++) {
                    ScreenModel *model = [ScreenArr objectAtIndex:i];
                    cell.textLabel.textColor = [UIColor lightGrayColor];
                    if (model.Tag == 202 || model.Tag ==203 || model.Tag ==204 || model.Tag == 205) {
                        if (model.Tag != checkbox.tag)
                        {
                            [ScreenArr removeObject:model];
            ...
            case 202:
            {
                ...
                for (int i = 0; i<[ScreenArr count]; i++) {
                    ScreenModel *model = [ScreenArr objectAtIndex:i];
                    cell.textLabel.textColor = [UIColor lightGrayColor];
                    if (model.Tag == 201 || model.Tag ==203 || model.Tag == 204 || model.Tag == 205) {
                        if (model.Tag != checkbox.tag)
                        {
                            [ScreenArr removeObject:model];
            ...
            case 203:
            {
                ...
                for (int i = 0; i<[ScreenArr count]; i++) {
                    ScreenModel *model = [ScreenArr objectAtIndex:i];
                    cell.textLabel.textColor = [UIColor lightGrayColor];
                    if (model.Tag == 202 || model.Tag ==201 || model.Tag ==204 || model.Tag == 205) {
                        if (model.Tag != checkbox.tag)
                        {
                            [ScreenArr removeObject:model];
            ...
            case 204:
            {
                ...
                for (int i = 0; i<[ScreenArr count]; i++) {
                    ScreenModel *model = [ScreenArr objectAtIndex:i];
                    cell.textLabel.textColor = [UIColor lightGrayColor];
                    if (model.Tag == 202 || model.Tag ==203 || model.Tag == 201 || model.Tag == 205) {
                        if (model.Tag != checkbox.tag)
                        {
                            [ScreenArr removeObject:model];
            ...
            case 205:
            {
                ...
                for (int i = 0; i<[ScreenArr count]; i++) {
                    ScreenModel *model = [ScreenArr objectAtIndex:i];
                    cell.textLabel.textColor = [UIColor lightGrayColor];
                    if (model.Tag == 202 || model.Tag == 203 || model.Tag == 204 || model.Tag == 201) {
                        if (model.Tag != checkbox.tag)
                        {
                            [ScreenArr removeObject:model];
...
- (void)SureBtnClick
{
    ...
    for (int i = 0; i<[ScreenArr count]; i++) {
        ...
        else   if (model.Tag>=201 && model.Tag <=205) {
