...
{
    NSString *URLString = @"app/services";
...
#warning 弹框
        if (AppDelegateInstance.userInfo.businessLicense.length>0) {
            UIAlertView *alertView = [[UIAlertView alloc]initWithTitle:@"提示" message:@"还未开通资金托管，请前往PC开户" delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
            [alertView show];
