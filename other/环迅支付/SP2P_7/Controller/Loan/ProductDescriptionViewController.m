...
- (void)initView
{
    ...
    //滚动视图
    _scrollView =[[UIScrollView alloc] initWithFrame:CGRectMake(0, -64, self.view.frame.size.width, 610)];
    ...
    UIView *backView1 = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, 145)];
    backView1.backgroundColor = [UIColor whiteColor];
    [_scrollView addSubview:backView1];
    
    UILabel  *textlabel1 = [[UILabel alloc] initWithFrame:CGRectMake(10, 72, 260,30)];
    ...
    _featuretextView = [[UITextView alloc] initWithFrame:CGRectMake(70, 70, self.view.frame.size.width-80, 70)];
...
//    _featuretextView.text = @"放款时间快，借款额度高，还款方式灵活。认证两项审核资料即可借款，95%的成年人均可成功借款。";
    ...
    UIView *backView2 = [[UIView alloc] initWithFrame:CGRectMake(0, 150, self.view.frame.size.width, 60)];
...
//    _crowdtextView.text = @"学生，工薪族，个体工商及私企业主，创业梦想家。";
    ...
    _backView3 = [[UIView alloc] initWithFrame:CGRectMake(0, 215, self.view.frame.size.width, 170)];
    ...
    UIView *backView4 = [[UIView alloc] initWithFrame:CGRectMake(0, 390, self.view.frame.size.width, 98)];
...
-(void) httpResponseSuccess:(NetWorkClient *)client dataTask:(NSURLSessionDataTask *)task didSuccessWithObject:(id)obj
{
    ...
    if ([[NSString stringWithFormat:@"%@",[dics objectForKey:@"error"]] isEqualToString:@"-1"]) {
        ...
        NSString *RangeStr = [NSString stringWithFormat:@"%@",[dics objectForKey:@"limitRange"]];
