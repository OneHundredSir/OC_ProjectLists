...
- (void)initView
{
    ...
    _phoneLabel = [[UILabel alloc] initWithFrame:CGRectMake(50, 120 - 64, 200, 30)];
    _phoneLabel.text = @"";
...
//    _phoneLabel.layer.borderColor = [[UIColor lightGrayColor] CGColor];
    ...
    _statuLabel = [[UILabel alloc] initWithFrame:CGRectMake(50, 160 - 64, 100, 30)];
    _statuLabel.text = @"";
...
//    _changeBtn = [UIButton buttonWithType:UIButtonTypeRoundedRect];
    _changeBtn.frame = CGRectMake(10, 280 - 64, self.view.frame.size.width-20, 45);
