...
- (void)initView
{
    ...
    _nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 72 - navBarH, 260,30)];
    ...
    UILabel  *textlabel2 = [[UILabel alloc] initWithFrame:CGRectMake(20,110 - navBarH, 280,50)];
    ...
    _emailLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, 170 - navBarH, 260,30)];
    ...
    AuctionBtn.frame = CGRectMake(self.view.frame.size.width*0.5-75, 230 - navBarH,150, 28);
