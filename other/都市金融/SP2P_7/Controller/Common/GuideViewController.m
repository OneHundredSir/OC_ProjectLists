...
- (void)viewDidLoad
{
    ...
    for (int i = 0; i < count; i++) {
        ...
        if (i == count-1) {
            ...
            UIButton *ClickBtn = [[UIButton alloc] initWithFrame:CGRectMake(i*width+90, height-150, MSWIDTH-180, 80)];
...
- (void)btnClick
{
    ...
    NavigationController *navigationController = [[NavigationController alloc] initWithRootViewController:loginView];
