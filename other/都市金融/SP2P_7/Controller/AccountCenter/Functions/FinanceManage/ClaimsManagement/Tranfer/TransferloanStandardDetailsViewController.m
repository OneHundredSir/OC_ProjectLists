...
-(void) httpResponseSuccess:(NetWorkClient *)client dataTask:(NSURLSessionDataTask *)task didSuccessWithObject:(id)obj
{
    ...
    if ([[NSString stringWithFormat:@"%@",[dics objectForKey:@"error"]] isEqualToString:@"-1"]) {
        ...
        if (![[obj objectForKey:@"expiryDate"] isEqual:[NSNull null]]) {
            ...
            tfLoan.expiryDate = [[NSString stringWithFormat:@"%@",[obj objectForKey:@"expiryDate"]] substringWithRange:NSMakeRange(0, 19)];
        ...
        if (![[obj objectForKey:@"annualRate"] isEqual:[NSNull null]]) {
            _annualRate.text = [NSString stringWithFormat:@"%.1f%%", [[obj objectForKey:@"annualRate"] doubleValue]];
        }else {
            _annualRate.text = @"0";
        }
