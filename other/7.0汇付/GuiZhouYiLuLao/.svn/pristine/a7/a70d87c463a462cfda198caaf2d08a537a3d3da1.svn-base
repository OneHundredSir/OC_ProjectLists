...
@implementation AuditingLoanCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _roundimgView = [[UIImageView alloc] initWithFrame:CGRectMake(250, 17, 30, 30)];
        [self addSubview:_roundimgView];
        
        _progressLabel = [[UILabel alloc] initWithFrame:CGRectMake(251, 24, 28, 15)];
