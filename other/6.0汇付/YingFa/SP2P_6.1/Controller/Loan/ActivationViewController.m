...
- (void)initView
{
    ...
    _nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 72, MSWIDTH-20,30)];
    ...
    UILabel  *textlabel2 = [[UILabel alloc] initWithFrame:CGRectMake(20,110, MSWIDTH-40,50)];
    ...
    _emailLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, 170, MSWIDTH-30,30)];
