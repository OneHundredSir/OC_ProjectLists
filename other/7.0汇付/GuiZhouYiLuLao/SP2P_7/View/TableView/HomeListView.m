...
//            DLOG(@"qully arr is %@",_qualityIdArr);
        ...
        backView.backgroundColor = BrownColor;
        ...
        if(qualityArrr.count)
        {
            ...
            for (int i =0; i < [qualityArrr count];i++)
            {
                ...
                [str addAttribute:NSForegroundColorAttributeName value:BrownColor range:NSMakeRange(nameLen+2+1+17,amountLen+1)];
                ...
                UIView *tapview = [tapClick view];
                DLOG(@"hhhhh 2222  is %d",i);
//                tapview.tag = label.tag;
                DLOG(@"hhhhh  is %ld",(long)tapview.tag);
                tapClick.numberOfTapsRequired = 1;
                tapClick.numberOfTouchesRequired = 1;
                tapClick.view.backgroundColor = [UIColor redColor];
...
//            DLOG(@"full arr is %@",_fullyIdArr);
        ...
        for (int i =0; i < [fullyArr count];i++)
        {
            ...
            [str addAttribute:NSForegroundColorAttributeName value:BluewordColor range:NSMakeRange(0, nameLen + 2)];
            [str addAttribute:NSForegroundColorAttributeName value:BrownColor range:NSMakeRange(nameLen + 2 + 1 + 5,amountLen+1)];
...
-(void)scrollTimer{
    ...
    switch (timeCount) {
        ...
        case 2:
        {
            ...
            [_scrollView setContentOffset:CGPointMake(2*MSWIDTH, 0) animated:YES];
        }
            break;
...
-(void)scrollTimer1
{
    ...
    switch (timeCount1) {
        ...
        case 2:
        {
            ...
            [_scrollView1 setContentOffset:CGPointMake(2*MSWIDTH, 0) animated:YES];
        }
            break;
