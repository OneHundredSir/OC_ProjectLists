...
- (void)initView
{
    ...
    for (int i = 0; i<3; i++) {
        ...
        UILabel *textlabel = [[UILabel alloc] initWithFrame:CGRectMake(16, 90+90*i, 81, 30)];
        ...
        UILabel *textlabel2 = [[UILabel alloc] initWithFrame:CGRectMake(16, CGRectGetMaxY([self.view viewWithTag:(i+10)].frame) + 8, 81, 30)];
    ...
    //输入框
    _textfield1 = [[UITextField alloc] initWithFrame:CGRectMake(CGRectGetMaxX([self.view viewWithTag:(0+100)].frame) + 4, CGRectGetMidY([self.view viewWithTag:(0+100)].frame) - 15, 200, 30)];
    ...
    //输入框
    _textfield2 = [[UITextField alloc] initWithFrame:CGRectMake(CGRectGetMaxX([self.view viewWithTag:(1 + 100)].frame) + 4, CGRectGetMidY([self.view viewWithTag:(1+100)].frame) - 15, 200, 30)];
    ...
    //输入框
    _textfield3 = [[UITextField alloc] initWithFrame:CGRectMake(CGRectGetMaxX([self.view viewWithTag:(2 + 100)].frame) + 4, CGRectGetMidY([self.view viewWithTag:(2 + 100)].frame) - 15, 200, 30)];
    ...
    _questionComboBox1 = [[AJComboBox alloc] initWithFrame:CGRectMake(CGRectGetMaxX([self.view viewWithTag:(0 + 10)].frame) + 4, CGRectGetMidY([self.view viewWithTag:(0 + 10)].frame) - 15, 200, 30)];
    ...
    [self.view addSubview:_questionComboBox1];
    
    _questionComboBox2 = [[AJComboBox alloc] initWithFrame:CGRectMake(CGRectGetMaxX([self.view viewWithTag:(1 + 10)].frame) + 4, CGRectGetMidY([self.view viewWithTag:(1 + 10)].frame) - 15, 200, 30)];
    ...
    [self.view addSubview:_questionComboBox2];
    
    _questionComboBox3 = [[AJComboBox alloc] initWithFrame:CGRectMake(CGRectGetMaxX([self.view viewWithTag:(2 + 10)].frame) + 4, CGRectGetMidY([self.view viewWithTag:(2 + 10)].frame) - 15, 200, 30)];
    ...
    [self.view addSubview:_questionComboBox3];
