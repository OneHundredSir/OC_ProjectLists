...
- (void)initContentView
{
    ...
    if (_isLogin) {
        ...
        _leftBut.tag = 1;
        [_leftBut setTitle:[NSString stringWithFormat:@"%d月",(int)monthnum - 1] forState:UIControlStateNormal];
        ...
        _rightBut.tag = 2;
        [_rightBut setTitle:[NSString stringWithFormat:@"%d月",(int)monthnum + 1] forState:UIControlStateNormal];
