    ...
    if ([[NSString stringWithFormat:@"%@",[dics objectForKey:@"error"]] isEqualToString:@"-1"]) {
        ...
        if (isOPT == 66) {
            ...
            for (NSDictionary *item in dataArr) {
                ...
                if ([item objectForKey:@"creditLevelApp"]!=nil && ![[item objectForKey:@"creditLevelApp"] isEqual:[NSNull null]]) {
                    if ([[[item objectForKey:@"creditLevelApp"] objectForKey:@"imageFilename"] hasPrefix:@"http"]) {
                        
                        bean.creditLevel = [NSString stringWithFormat:@"%@",[[item objectForKey:@"creditLevelApp"] objectForKey:@"imageFilename"]];//信用等级
                    }else
                    {
                         bean.creditLevel = [NSString stringWithFormat:@"%@%@", Baseurl, [[item objectForKey:@"creditLevelApp"] objectForKey:@"imageFilename"]];//信用等级
