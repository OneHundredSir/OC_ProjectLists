...
- (void)initView
{
    ...
    CGFloat backViewH = 104 -64.f;
    UIView *backView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, backViewH)];
    ...
    _listView = [[UITableView alloc] initWithFrame:CGRectMake(0, backViewH, self.view.frame.size.width, self.view.frame.size.height-backViewH) style:UITableViewStyleGrouped];
