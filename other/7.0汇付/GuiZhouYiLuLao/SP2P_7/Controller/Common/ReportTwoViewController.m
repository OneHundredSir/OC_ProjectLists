...
@interface ReportTwoViewController()<UITextViewDelegate,HTTPClientDelegate>
...
@implementation ReportTwoViewController
...
//    _titleLabel2.text = [NSString stringWithFormat:@"被举报人:%@***",[_borrowName substringWithRange:NSMakeRange(0, 1)]];
...
//    
//    
    UILabel  *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 80, self.view.frame.size.width-20, 30)];
    ...
    _reasonView  = [[UITextView alloc]  initWithFrame:CGRectMake(10, 110, self.view.frame.size.width-20, 100)];
    ...
    reportBtn.frame = CGRectMake(self.view.frame.size.width*0.5-70, 260,140, 40);
...
- (void)reportBtnClick
{
    ...
    [parameters setObject:[NSString stringWithFormat:@"%@",_bidIdSign] forKey:@"sign"];
    [parameters setObject:[NSString stringWithFormat:@"%@",AppDelegateInstance.userInfo.userId] forKey:@"id"];
    [parameters setObject:[NSString stringWithFormat:@"%@",_debtUserIdSign] forKey:@"bidUserIdSign"];
    [parameters setObject:@"" forKey:@"bidIdSign"];
