...
@interface InBoxViewController ()<UITableViewDelegate,UITableViewDataSource, HTTPClientDelegate, UIActionSheetDelegate>
{
...
//    [_listView headerBeginRefreshing];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(updateTable:) name:@"InBoxMegSuccess" object:nil];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (editStatus) {
        ...
        IBOrdinaryDetailViewController *message = [[IBOrdinaryDetailViewController alloc] init];
...
- (void)editButtonClicked:(id)sender {
    if (_dataArrays.count == 0) {
        [SVProgressHUD showImage:nil status:@"暂无可编辑的信息!"];
        return;
    }
...
- (void)requestData
{
    if (AppDelegateInstance.userInfo == nil) {
        ...
        [parameters setObject:@"83" forKey:@"OPT"];
        [parameters setObject:@"" forKey:@"body"];
        [parameters setObject:AppDelegateInstance.userInfo.userId forKey:@"id"];
