//
//  VerifySafeQuestionViewTwoController.m
//  SP2P_7
//
//  Created by Jerry on 14-6-30.
//  Copyright (c) 2014年 EIMS. All rights reserved.
//
// 账户管理 - 安全问题设置 - 安全问题设置 - 安全问题校验
...
@interface VerifySafeQuestionViewTwoController ()<UITextFieldDelegate,UIAlertViewDelegate, HTTPClientDelegate>
{
...
@implementation VerifySafeQuestionViewTwoController
...
- (void)initView
{
    ...
    CGFloat selfW = self.view.frame.size.width;
    //滚动视图
    _scrollView =[[MSKeyboardScrollView alloc] initWithFrame:CGRectMake(0, 0, selfW, MSHIGHT-64)];
    ...
    UILabel *textlabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 0, selfW - 2*10, 60)];
    ...
    _questionlabel1 = [[UILabel alloc] initWithFrame:CGRectMake(95, 60, 230, 30)];
    ...
    _questionlabel2 = [[UILabel alloc] initWithFrame:CGRectMake(95, 140, 230, 30)];
    ...
    _questionlabel3 = [[UILabel alloc] initWithFrame:CGRectMake(95, 220, 230, 30)];
