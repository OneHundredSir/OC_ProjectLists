...
- (void)initContentView
{
    ...
    if (_isLogin) {
        ...
        _leftBut.tag = 1;
        [_leftBut setTitle:[NSString stringWithFormat:@"%ld月",(long)monthnum - 1] forState:UIControlStateNormal];
        ...
        _rightBut.tag = 2;
        [_rightBut setTitle:[NSString stringWithFormat:@"%ld月",(long)monthnum + 1] forState:UIControlStateNormal];
