...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.section) {
        case 0:
        {
            ExtensionBaseViewController *extensionView = [[ExtensionBaseViewController alloc] init];
        ...
        default:
        {
            ...
            // 正文
            [controller setMessageBody:[NSString stringWithFormat:@"一路捞APP全新面世%@",_imgUrl] isHTML:YES];
...
//                TabViewController *tabViewController = [[TabViewController alloc] init];
        ...
        case 2:
        {
            ...
            if (AppDelegateInstance.userInfo == nil) {
                ...
                DLOG(@"分享地址：%@",[NSString stringWithFormat:@"%@/reg?recommendName=%@",Baseurl,AppDelegateInstance.userInfo.userName]);
                
                //构造分享内容
                id<ISSContent> publishContent = [ShareSDK content:@"一路捞APP全新面世"
                                                   defaultContent:@""
