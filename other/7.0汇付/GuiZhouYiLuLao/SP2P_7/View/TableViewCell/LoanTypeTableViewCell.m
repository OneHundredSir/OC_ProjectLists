...
- (void)layoutSubviews
{
    ...
    if (self.object) {
        ...
        if ([object.imageurl hasPrefix:@"http"]) {
            ...
            [_showImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",Baseurl,object.imageurl]]
             
                              placeholderImage:[UIImage imageNamed:@"news_image_default"]];
             
        }
        _expanBtn.frame = CGRectMake(MSWIDTH-35, 35, 25, 20);
