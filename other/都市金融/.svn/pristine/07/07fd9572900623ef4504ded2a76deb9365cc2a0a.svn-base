...
- (void)initView
{
    ...
    CGFloat _titleLabel1Y = 70.f - 64;
    _titleLabel1 = [[UILabel alloc] initWithFrame:CGRectMake(10, _titleLabel1Y, self.view.frame.size.width, 30)];
...
//    _titleLabel1.text = [NSString stringWithFormat:@"发给: %@",self.borrowName];
    ...
    CGFloat titleLabelY = _titleLabel1Y + 30;
    UILabel  *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, titleLabelY, 40, 30)];
    ...
    _titleField = [[UITextField alloc] initWithFrame:CGRectMake(50, titleLabelY, self.view.frame.size.width-60, 30)];
    ...
    CGFloat titleLabel2y = titleLabelY + 30;
    UILabel  *titleLabel2 = [[UILabel alloc] initWithFrame:CGRectMake(10, titleLabel2y, self.view.frame.size.width-30, 30)];
    ...
    [self.view addSubview:titleLabel2];
      ...
      CGFloat _contentViewY = titleLabel2y + 35;
    _contentView  = [[UITextView alloc]  initWithFrame:CGRectMake(10, _contentViewY, self.view.frame.size.width-20, 80)];
    ...
    [self.view addSubview:_contentView];
     ...
     CGFloat reportBtnY = _contentViewY + 100;
    UIButton *reportBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    reportBtn.frame = CGRectMake(self.view.frame.size.width*0.5-70, reportBtnY,140, 40);
