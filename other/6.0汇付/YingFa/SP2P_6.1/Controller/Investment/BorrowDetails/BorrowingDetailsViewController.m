...
@property(nonatomic ,strong) UIButton *tenderBtn;//立即投标
@end
...
//    _idLabel.text = [NSString stringWithFormat:@"J%@",_borrowID];
    ...
    _collectBtn.frame = CGRectMake(160, 36, 20, 20);
    ...
    _progressView = [[LDProgressView alloc] initWithFrame:CGRectMake(15, 70, MSWIDTH-55, 4)];
    ...
    _roundimgView = [[UIImageView alloc] initWithFrame:CGRectMake(MSWIDTH-40, 55, 30, 30)];
    _roundimgView.image = [UIImage imageNamed:@"round_back"];
    [_ScrollView addSubview:_roundimgView];
    
    _progressLabel = [[UILabel alloc] initWithFrame:CGRectMake(MSWIDTH-37, 62, 30, 15)];
    ...
    dateBackView = [[UIView alloc] initWithFrame:CGRectMake(10, 180, 110, 30)];
    dateBackView.backgroundColor = PinkColor;
    [_ScrollView addSubview:dateBackView];
    
    dateLabel1 = [[UILabel alloc] initWithFrame:CGRectMake(50, 180, 110, 30)];
    ...
    clockImg = [[UIImageView alloc] initWithFrame:CGRectMake(20, 185, 22, 22)];
    clockImg.image = [UIImage imageNamed:@"clock_big"];
    clockImg.backgroundColor = [UIColor clearColor];
    [_ScrollView addSubview:clockImg];
    
    _dateLabel2 = [[UILabel alloc] initWithFrame:CGRectMake(120, 180, MSWIDTH-130, 30)];
        ...
        case 0:
                {
                   // if (AppDelegateInstance.userInfo != nil) {
                        ...
                        _tenderBtn.frame = CGRectMake(self.view.frame.size.width * 0.5 - 60, 7, 120, 30);
...
//}
        ...
        case 1:
        {
            ...
            if (AppDelegateInstance.userInfo != nil) {
                ...
                tenderBtn.frame = CGRectMake(self.view.frame.size.width * 0.5 - 60, 7, 120, 30);
                ...
                tenderBtn.titleLabel.font = [UIFont fontWithName:@"Arial-BoldMT" size:14.0];
...
-(void) httpResponseSuccess:(NetWorkClient *)client dataTask:(NSURLSessionDataTask *)task didSuccessWithObject:(id)obj
{
    ...
    if ([[NSString stringWithFormat:@"%@",[dics objectForKey:@"error"]] isEqualToString:@"-1"]) {
        if (num2 == 1) {
            ...
            _rateLabel.text = [NSString stringWithFormat:@"%0.2f%%",[[dics objectForKey:@"annualRate"] floatValue]];
            ...
            if (_statuNum == 1 || _statuNum == 2 || _statuNum == 3) {
                ...
                if ([_progressLabel.text isEqualToString:@"100%"])
                {
                    ...
                    dateLabel1.hidden = YES;
                    clockImg.hidden = YES;
                    _dateLabel2.hidden = YES;
                    _listView.frame = CGRectMake(0, 165, self.view.frame.size.width, 800);
                }
...
//        cell.NameLabel.text = _borrowername;
        ...
        if (_creditRating!= nil && ![_creditRating isEqual:[NSNull null]])
        {
        ...
        [cell.CalculateBtn setImage:[UIImage imageNamed:@"menu_calculator1"] forState:UIControlStateNormal];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.section) {
        ...
        case 1:
        {
            ...
            _listView.frame = CGRectMake(0, self.listView.frame.origin.y, MSWIDTH, self.view.frame.size.height+labelSize.height+10);
            ...
            [folderTableView openFolderAtIndexPath:indexPath WithContentView:DetailsDescriptionView.view
                                         openBlock:^(UIView *subClassView, CFTimeInterval duration, CAMediaTimingFunction *timingFunction){
                                             ...
                                             _ScrollView.contentSize = CGSizeMake(self.view.frame.size.width,self.view.frame.size.height+labelSize.height+tableArr.count*42+330);
            ...
            [folderTableView openFolderAtIndexPath:indexPath WithContentView:MaterialAuditSubjectView.view
                                         openBlock:^(UIView *subClassView, CFTimeInterval duration, CAMediaTimingFunction *timingFunction){
                                             ...
                                             btn.selected = !btn.selected;
                                              ...
                                              _ScrollView.contentSize = CGSizeMake(self.view.frame.size.width,self.view.frame.size.height+_AuditdataArr.count*35+tableArr.count*42+330);
...
- (void)timeDown:(NSString *)timeStr
{
    ...
    if (days <= 0&&hours <= 0&&minute <= 0&&seconds<=0)
    {
        ...
        [_tenderBtn removeFromSuperview];
    }
    else
    {
