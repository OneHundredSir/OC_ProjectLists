...
- (void)initView
{
    ...
    _userName = [[UILabel alloc] initWithFrame:CGRectMake(10, 70, 300, 30)];
    ...
    _creditLevel = [[UIImageView alloc] initWithFrame:CGRectMake(140, 105, 35, 15)];
    _creditLevel.contentMode = UIViewContentModeScaleAspectFill;
    ...
    _overCreditLinelabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 220, 300, 20)];
    ...
    ApplyBtn.backgroundColor = BrownColor;
...
-(void) setView
{
    [_creditLevel  sd_setImageWithURL:[NSURL URLWithString:_creditLevelModel.creditRating]
