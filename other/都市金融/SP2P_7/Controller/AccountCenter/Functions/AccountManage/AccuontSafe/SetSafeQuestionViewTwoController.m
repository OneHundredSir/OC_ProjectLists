...
- (void)initView
{
    ...
    for (int i = 0; i<3; i++) {
        ...
        UILabel *textlabel2 = [[UILabel alloc] initWithFrame:CGRectMake(20, textlabelY + 40+80*i, 200, 30)];
        textlabel2.text = @"答案:************************";
    ...
    _questionlabel1 = [[UILabel alloc] initWithFrame:CGRectMake(95, textlabelY, 230, 30)];
    ...
    _questionlabel2 = [[UILabel alloc] initWithFrame:CGRectMake(95, textlabelY + 80, 230, 30)];
    ...
    _questionlabel3 = [[UILabel alloc] initWithFrame:CGRectMake(95, textlabelY + 80*2, 230, 30)];
    ...
    _modifyBtn.frame = CGRectMake(10, CGRectGetMaxY(_questionlabel3.frame) + 20 + 60, self.view.frame.size.width-20, 45);
