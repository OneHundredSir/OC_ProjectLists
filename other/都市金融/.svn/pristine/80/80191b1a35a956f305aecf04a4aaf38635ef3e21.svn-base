...
//        UILabel *myLabel = [[UILabel alloc] initWithFrame:RM(0, 0, 0.75*self.frame.size.width, 0.75*self.frame.size.height)];
...
//        
//        UIGraphicsBeginImageContextWithOptions(myLabel.frame.size, NO, 0.0f);
