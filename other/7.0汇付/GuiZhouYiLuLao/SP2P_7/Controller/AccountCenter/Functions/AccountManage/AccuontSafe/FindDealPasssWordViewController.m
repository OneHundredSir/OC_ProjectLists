...
- (void)initView
{
    ...
    //输入框
    _authCodeField = [[UITextField alloc] initWithFrame:CGRectMake(10, 140, 150,40)];
    ...
    _verifyBtn.frame = CGRectMake(185, 140, 120, 40);;
    ...
    nextBtn.frame = CGRectMake(10, 220, self.view.frame.size.width-20, 45);
    [nextBtn setTitle:@"下一步" forState:UIControlStateNormal];
    nextBtn.layer.cornerRadius = 3.0f;
    nextBtn.layer.masksToBounds = YES;
    nextBtn.backgroundColor = BrownColor;
