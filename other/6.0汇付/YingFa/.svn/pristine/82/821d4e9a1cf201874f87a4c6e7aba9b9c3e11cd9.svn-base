...
- (void)initData
{
    ...
    _sortGrop = [[SortItemGrop alloc] initWithFrame:CGRectMake(0, kSortHeight - 4.0, MSWIDTH, 4) sortArrays:_sortArrays defaultPosition:0];
    int i=0;
...
-(void)requestData:(NSString*)orderTypeStr
{
    ...
    //        [parameters setObject:@"" forKey:@"keywords"];   //关键字	借款标题或编号
    //        [parameters setObject:[NSString stringWithFormat:@"%d",_currPage] forKey:@"currPage"];  //当前页数
    //    }
    //
...
- (void)itemClick:(SortItem *)sender
{
    ...
    switch (sender.tag) {
        case 0:{
            if (isclick1) {
                //                NSSortDescriptor *sort = [NSSortDescriptor sortDescriptorWithKey:@"creditorId" ascending:NO];//降序排序
                ...
                //                NSSortDescriptor *sort = [NSSortDescriptor sortDescriptorWithKey:@"creditorId" ascending:YES];
                //                [_dataArrays sortUsingDescriptors:[NSArray arrayWithObject:sort]];
                _orderStr = @"0";
                [self requestData:_orderStr];
        ...
        {
            if (isclick2) {
                //                NSSortDescriptor *sort = [NSSortDescriptor sortDescriptorWithKey:@"principal" ascending:NO];//降序排序
                //                [_dataArrays sortUsingDescriptors:[NSArray arrayWithObject:sort]];
                [sender setState:SortDesc];
                isclick2=NO;
                _orderStr = @"1";
            ...
            else
            {
                ...
                //                NSSortDescriptor *sort = [NSSortDescriptor sortDescriptorWithKey:@"principal" ascending:YES];//升序排序
                //                [_dataArrays sortUsingDescriptors:[NSArray arrayWithObject:sort]];
                [sender setState:SortAsc];
                isclick2=YES;
                _orderStr = @"2";
        ...
        case 2:
        {
            ...
            if (isclick3) {
                //                        NSSortDescriptor *sort = [NSSortDescriptor sortDescriptorWithKey:@"apr" ascending:NO];
                //                        [_dataArrays sortUsingDescriptors:[NSArray arrayWithObject:sort]];
                [sender setState:SortDesc];
                isclick3=NO;
                _orderStr = @"3";
            ...
            else
            {
                ...
                //                        NSSortDescriptor *sort = [NSSortDescriptor sortDescriptorWithKey:@"apr" ascending:YES];
                //                        [_dataArrays sortUsingDescriptors:[NSArray arrayWithObject:sort]];
                [sender setState:SortAsc];
                isclick3=YES;
                _orderStr = @"4";
            ...
            
        {
            ...
            {
                //
                //                NSSortDescriptor *sort = [NSSortDescriptor sortDescriptorWithKey:@"sortTime" ascending:YES];
                //                [_dataArrays sortUsingDescriptors:[NSArray arrayWithObject:sort]];
                [sender setState:SortAsc];
                isclick4=YES;
                _orderStr = @"6";
        ...
        case 4:
        {
            ...
            if (isclick5) {
                //                NSSortDescriptor *sort = [NSSortDescriptor sortDescriptorWithKey:@"repaytime" ascending:NO];
                //                [_dataArrays sortUsingDescriptors:[NSArray arrayWithObject:sort]];
                [sender setState:SortDesc];
                isclick5=NO;
                _orderStr = @"7";
            ...
            {
                //
                //                NSSortDescriptor *sort = [NSSortDescriptor sortDescriptorWithKey:@"repaytime" ascending:YES];
                //                [_dataArrays sortUsingDescriptors:[NSArray arrayWithObject:sort]];
                [sender setState:SortAsc];
                isclick5=YES;
                _orderStr = @"8";
