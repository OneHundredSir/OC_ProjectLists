...
@class SCNavTabBar, SCNavTabBarController;

@protocol SCNavTabBarControllerDelegate <NSObject>// 周李强 add
...
@property (nonatomic, strong) SCNavTabBar     *navTabBar;                // NavTabBar: press item on it to exchange view --- 本句代码本来位置在扩展里面
@property (nonatomic, weak) id<SCNavTabBarControllerDelegate> delegate; // 周李强 add
