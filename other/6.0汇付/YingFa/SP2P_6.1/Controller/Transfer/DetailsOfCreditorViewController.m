...
- (void)initView
{
    ...
    _ScrollView.contentSize = CGSizeMake(self.view.frame.size.width, 1180);
    ...
    UILabel *idtextLabel = [[UILabel alloc] initWithFrame:CGRectMake(MSWIDTH-80, 10, 80, 25)];
    idtextLabel.text = @"编号: ";
    ...
    _idLabel = [[UILabel alloc] initWithFrame:CGRectMake(MSWIDTH-50, 10, 80, 25)];
    ...
    UIImageView *clockimg = [[UIImageView alloc] initWithFrame:CGRectMake(75, 38, 21, 20)];
    clockimg.image = [UIImage imageNamed:@"clock_small"];
    clockimg.backgroundColor = PinkColor;
    [_ScrollView addSubview:clockimg];
    
    
    _dateLabel2 = [[UILabel alloc] initWithFrame:CGRectMake(96, 38, 105, 20)];
    //    _dateLabel2.text =@"12天23小时34分54秒";
    _dateLabel2.textColor = [UIColor whiteColor];
    _dateLabel.textAlignment = NSTextAlignmentCenter;
    _dateLabel2.backgroundColor = PinkColor;
    _dateLabel2.font = [UIFont boldSystemFontOfSize:11.0f];
    ...
    _collectBtn.frame = CGRectMake(220, 36, 20, 20);
    ...
    //    _progressView = [[LDProgressView alloc] initWithFrame:CGRectMake(15, 68, 265, 4)];
    ...
    _moneyLabel2 = [[UILabel alloc] initWithFrame:CGRectMake(215, 75, 100, 20)];
    ...
    _moneyLabel3 = [[UILabel alloc] initWithFrame:CGRectMake(75, 94, 100, 20)];
    ...
    _detailView = [[UITextView alloc] initWithFrame:CGRectMake(0, 120, self.view.frame.size.width, 50)];
    ...
    _listView = [[UIFolderTableView alloc] initWithFrame:CGRectMake(0, 180, self.view.frame.size.width, 840)  style:UITableViewStyleGrouped];
    ...
    //if (AppDelegateInstance.userInfo != nil) {//此判断为如果没登录，按钮不显示
    
    bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 44, self.view.frame.size.width, 44)];
    ...
    auctionBtn.frame = CGRectMake(self.view.frame.size.width * 0.5 - 60, 7, 120, 30);
    ...
    auctionBtn.titleLabel.font = [UIFont fontWithName:@"Arial-BoldMT" size:14.0];
    ...
    [bottomView addSubview:auctionBtn];
...
-(void) httpResponseSuccess:(NetWorkClient *)client dataTask:(NSURLSessionDataTask *)task didSuccessWithObject:(id)obj
{
    ...
    if ([[NSString stringWithFormat:@"%@",[dics objectForKey:@"error"]] isEqualToString:@"-1"]) {
        ...
        if (_num == 1) {
            ...
            //历史纪录部分
            _registrationTime = [dics objectForKey:@"registrationTime"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        if ([[NSString stringWithFormat:@"%@",_creditRating] hasPrefix:@"http"]) {
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.section) {
        ...
        case 2:
        {
            ...
            CGSize labelSize = [result boundingRectWithSize:CGSizeMake(self.view.frame.size.width-30, 2000) options:NSStringDrawingUsesLineFragmentOrigin attributes:attributes context:nil].size;
            ...
            [folderTableView openFolderAtIndexPath:indexPath WithContentView:DetailsDescriptionView.view
                                         openBlock:^(UIView *subClassView, CFTimeInterval duration, CAMediaTimingFunction *timingFunction){
                                             ...
                                             _ScrollView.contentSize = CGSizeMake(self.view.frame.size.width,self.view.frame.size.height+labelSize.height+tableArr.count*42+300);
        ...
        case 3:
        {
            ...
            for (int i = 0; i<[_AuditdataArr count]; i++) {
                ...
                UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 5+35*i, 120, 30)];
                ...
                [lookBtn setFrame:CGRectMake(MSWIDTH-80, 5+35*i, 80, 30)];
            ...
            [folderTableView openFolderAtIndexPath:indexPath WithContentView:MaterialAuditSubjectView.view
                                         openBlock:^(UIView *subClassView, CFTimeInterval duration, CAMediaTimingFunction *timingFunction){
                                             ...
                                             //[self CloseAndOpenACtion:indexPath];
                                             btn.selected = !btn.selected;
                                             _ScrollView.contentSize = CGSizeMake(self.view.frame.size.width,self.view.frame.size.height+_AuditdataArr.count*35+tableArr.count*42+300);
                                         }
                                        closeBlock:^(UIView *subClassView, CFTimeInterval duration, CAMediaTimingFunction *timingFunction){
                                            // closing actions
                                            //[self CloseAndOpenACtion:indexPath];
...
- (void)ShareClick
{
    if (AppDelegateInstance.userInfo == nil) {
        ...
        //构造分享内容
        id<ISSContent> publishContent = [ShareSDK content:[NSString stringWithFormat:@"sp2p 6.0华夏企贷网 债权标详情%@",shareUrl]
                                           defaultContent:@"默认分享内容，没内容时显示"
                                                    image:[ShareSDK pngImageWithImage:[UIImage imageNamed:@"logo"]]
                                                    title:@"sp2p 6.0华夏企贷网 债权标"
                                                      url:shareUrl
                                              description:@"债权详情"
