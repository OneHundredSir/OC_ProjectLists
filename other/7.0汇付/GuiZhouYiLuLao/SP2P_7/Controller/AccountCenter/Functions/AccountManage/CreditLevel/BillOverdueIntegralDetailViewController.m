//
//  BillOverdueIntegralDetailViewController.m
//  SP2P_7
//
...
@interface BillOverdueIntegralDetailViewController ()<UITableViewDataSource,UITableViewDelegate, HTTPClientDelegate>
{
...
@implementation BillOverdueIntegralDetailViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.backView setImage:[UIImage imageNamed:@"round_back"]];
    
    BillOverdueIntegral *bean = _dataArrays[indexPath.section];
...
//    cell.otherLabel.text = bean.period;
...
//        [self hiddenRefreshView];
    ...
    [parameters setObject:@"119" forKey:@"OPT"];
...
//    [self hiddenRefreshView];
    ...
    if ([[NSString stringWithFormat:@"%@",[dics objectForKey:@"error"]] isEqualToString:@"-1"]) {
        ...
        for (NSDictionary *item in dataArr) {
            ...
            BillOverdueIntegral *bean = [[BillOverdueIntegral alloc] init];
            ...
            bean.period = [item objectForKey:@"period"] ; // 比例
