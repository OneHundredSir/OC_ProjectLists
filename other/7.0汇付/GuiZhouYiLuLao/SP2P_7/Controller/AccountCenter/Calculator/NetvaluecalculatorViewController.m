...
- (void)initData
{
    titleArr = [NSMutableArray arrayWithObjects:@"可用余额",@"代收金额",@"代还金额",@"元",@"%",@"月",nil];
}
...
- (void)initView
{
    ...
    UIView *topView = [[UIView alloc] initWithFrame:CGRectMake(10, 74, MSWIDTH-20, 320)];
    ...
    _balance.font = [UIFont systemFontOfSize:12.0f];
    [topView addSubview:_balance];
    ...
    _receive.font = [UIFont systemFontOfSize:12.0f];
    ...
    _pay.delegate = self;
    _pay.placeholder = @"请输入代还金额";
    _pay.font = [UIFont systemFontOfSize:12.0f];
    _pay.keyboardType = UIKeyboardTypeDecimalPad;
    [topView addSubview:_pay];
    
    UIButton *calculateBtn = [UIButton buttonWithType:UIButtonTypeRoundedRect];
    [calculateBtn setFrame:CGRectMake(topView.frame.size.width * 0.5 - 40, 180, 80, 30)];
    ...
    [topView addSubview:calculateBtn];
