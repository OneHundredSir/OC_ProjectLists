...
//    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"确定接受" message:[NSString stringWithFormat:@"您确定以 %@ 元的竞价购买了用户 %@ %@ 元的债权吗？", _maxOfferPrice, _bidName, _receivedAmount] delegate:self cancelButtonTitle:@"确定" otherButtonTitles:@"取消", nil];
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"确定接受" message:[NSString stringWithFormat:@"您是否确定以 %@元 购买此债权？", _maxOfferPrice] delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"确定", nil];
...
//    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"拒绝转让" message:[NSString stringWithFormat:@"您确定拒绝用户 %@ 向您发起的定向转让吗？", _bidName] delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"确定", nil];
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"拒绝转让" message:[NSString stringWithFormat:@"您是否确定拒绝此债权？"] delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"确定", nil];
    ...
    switch (buttonIndex) {
        case 1:
        {
            if (AppDelegateInstance.userInfo == nil) {
                  [ReLogin outTheTimeRelogin:self];                return;
            }
...
//            requestType = 59;
            ...
            [parameters setObject:self.sign forKey:@"sign"];
            ...
            if (IS_TRUSTEESHIP) {
                [_requestClient requestGet:self withParameters:parameters payType:TYPE_TRANSFER navLevel:[self.navigationController.viewControllers indexOfObject:self]-1];
            }else{
