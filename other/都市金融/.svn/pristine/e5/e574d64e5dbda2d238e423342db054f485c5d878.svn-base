...
- (void)initView
{
    ...
    CGFloat navBarH = 64.f;
    UILabel *textlabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 60 - navBarH, selfW - 10*2, 60)];
    ...
    CGFloat textlabelY = 120 - navBarH;
    CGFloat textlabel2Y = 160 - navBarH;
    for (int i = 0; i<3; i++) {
    ...
    _questionlabel1 = [[UILabel alloc] initWithFrame:CGRectMake(95, 120 - navBarH, 230, 30)];
    ...
    _questionlabel2 = [[UILabel alloc] initWithFrame:CGRectMake(95, 200 - navBarH, 230, 30)];
    ...
    _questionlabel3 = [[UILabel alloc] initWithFrame:CGRectMake(95, 280 - navBarH, 230, 30)];
    ...
    SureBtn.frame = CGRectMake(10, 390 - navBarH, self.view.frame.size.width-20, 45);
    ...
    mailBtn.frame = CGRectMake(10, 450 - navBarH, 100, 15);
...
- (void)SureBtnClick
{
     [SVProgressHUD showErrorWithStatus:@"请完善填写"];
    DLOG(@"提交确定按钮");
