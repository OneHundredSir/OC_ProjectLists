...
- (void)initData
{
    ...
    titleArr = @[@"入驻平台时间:",@"众筹成功次数:",@"成功分享收益:"];//,@"逾期还款次数:",@"   待还款金额:",@"共计借入金额:",@"理财投标笔数:",@"   待收款金额:"
...
- (void)initView
{
    ...
    self.view.frame = CGRectMake(0, 0, 1000, 210/2);
    ...
    UILabel *timeLabel = [[UILabel alloc] initWithFrame:CGRectMake(110, 5, 150, 30)];
...
//    [self.view addSubview:limitLabel];
    ...
    UILabel *repaymentLabel = [[UILabel alloc] initWithFrame:CGRectMake(110,105, 150, 30)];
...
//    [self.view addSubview:repaymentLabel];
    ...
    UILabel *borrowLabel = [[UILabel alloc] initWithFrame:CGRectMake(110,130, 150, 30)];
...
//    [self.view addSubview:tenderLabel];
    ...
    UILabel *receiptLabel = [[UILabel alloc] initWithFrame:CGRectMake(110,180, 150, 30)];
