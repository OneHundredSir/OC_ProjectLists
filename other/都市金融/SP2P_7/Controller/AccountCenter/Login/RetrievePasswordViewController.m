...
- (void)initContentView
{
    ...
    // 手机号 输入框
    CGFloat _phoneWindowY= 84.f-64;
    _phoneWindow = [[LoginWindowTextField alloc] initWithFrame:CGRectMake(20, _phoneWindowY, kWidthWin, 35)];
...
//    [self.view addSubview:label3];
    // 验证码 输入框
     CGFloat _verificationWindowY= _phoneWindowY + 50;
    _verificationWindow = [[LoginWindowTextField alloc] initWithFrame:CGRectMake(20, _verificationWindowY, self.view.frame.size.width - 170, 35)];
    ...
    _verificationBtn.frame = CGRectMake(self.view.frame.size.width - 140, _verificationWindowY, 120, 35);
...
//    [self.view addSubview:label5];
     CGFloat signBtnY= _verificationWindowY + 50;
    UIButton *signBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    signBtn.frame = CGRectMake(20, signBtnY, kWidthWin, 35);
