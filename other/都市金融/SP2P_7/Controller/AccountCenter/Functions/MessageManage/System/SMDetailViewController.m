...
- (void)initView
{
    ...
    _scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 45, self.view.frame.size.width, self.view.frame.size.height - 90)];
    _scrollView.backgroundColor = [UIColor clearColor];
    [self.view addSubview:_scrollView];
    
//    //  顶部白背景，隐藏滚动内容不可见。
//    UIView *topView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, 10)];
//    topView.backgroundColor = KblackgroundColor;
//    [self.view addSubview:topView];
    
    // 标题
    _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, 11, 150, 30)];
...
//    [self.view addSubview:line];
    ...
    //  底部模块及一些按钮功能
    UIView *bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 40 - 64, self.view.frame.size.width, 40)];
...
//            _timeLabel.text = [dataFormat stringFromDate:date];
            ...
            _contentLabel.text = [NSString stringWithFormat:@"/t%@", [[obj objectForKey:@"page"] objectForKey:@"content"]];
            ...
            _scrollView.contentSize = CGSizeMake(0, _label1Sz.height + 10);
