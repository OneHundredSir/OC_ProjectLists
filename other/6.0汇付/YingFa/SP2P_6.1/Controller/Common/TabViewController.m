...
- (void)viewDidLoad
{
    ...
    investmentVc.view.backgroundColor = [UIColor whiteColor];
    ...
    transferVc.view.backgroundColor = [UIColor whiteColor];
    
    SliderViewController *SliderVc = [[SliderViewController alloc] init];
    SliderVc.view.backgroundColor = [UIColor whiteColor];
    ...
    UINavigationController *informationVN= [[UINavigationController alloc] initWithRootViewController:SliderVc];
