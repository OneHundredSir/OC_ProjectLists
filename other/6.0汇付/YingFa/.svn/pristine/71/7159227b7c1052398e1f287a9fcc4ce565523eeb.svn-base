...
- (void)initView
{
    ...
    _textlabel4 = [[UILabel alloc] initWithFrame:CGRectMake(20, 240, MSWIDTH-40, 20)];
...
-(void)updateList:(NSNotification *)notification
{
    ...
    _textlabel4.frame = CGRectMake(20, 232+74*_listArray.count, self.view.frame.size.width-40, 20);
