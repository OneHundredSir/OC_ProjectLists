...
- (void)initView
{
    ...
    UILabel *namelabel = [[UILabel alloc] initWithFrame:CGRectMake(20, 95, MSWIDTH-40, 30)];
    ...
    _reasonTextView = [[UITextView alloc] initWithFrame:CGRectMake(10, 145, MSWIDTH-20, 120)];
    ...
    SureBtn.frame = CGRectMake(self.view.frame.size.width*0.5-60, 320,120, 30);
   SureBtn.backgroundColor = GreenColor;
    [SureBtn setTitle:@"确认" forState:UIControlStateNormal];
   [SureBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateHighlighted];
    SureBtn.titleLabel.font = [UIFont fontWithName:@"Arial-BoldMT" size:14.0];
