...
@interface FinanceTransferViewController ()<UIScrollViewDelegate,UITextFieldDelegate,AJComboBoxDelegate, HTTPClientDelegate>
{
    ...
    int status;  // 转让方式 状态
    NSInteger _transferPeriods;  // 转让期限
...
- (void)initView
{
    ...
    _transferTitle.frame = CGRectMake(85, 10, MSWIDTH-140, 28);
    ...
    _transferBP.keyboardType = UIKeyboardTypeDecimalPad;
    ...
    textlabel.text = [NSString stringWithFormat:@"注:待收本金为%@元", _bidAmount];
    ...
    //dfasdfasd
    _comboBox = [[AJComboBox alloc] initWithFrame:CGRectMake(80, 108, 100, 28)];
    ...
    _dateBox = [[AJComboBox alloc] initWithFrame:CGRectMake(80, 143, 100, 28)];
    ...
    _transferReason.frame = CGRectMake(10, 200, MSWIDTH-20, 70);
    ...
    _SureBtn.frame = CGRectMake(self.view.frame.size.width*0.5-60, 285,120, 30);
    ...
    _SureBtn.titleLabel.font = [UIFont fontWithName:@"Arial-BoldMT" size:14.0];
...
- (void)SureBtnClick
{
    ...
    DLOG(@"_transferPeriods -> %ld", (long)_transferPeriods);
    ...
    if ([_transferTitle.text isEqual: @""]) {
        ...
        if (status == 0) {
            ...
            [parameters setObject:[NSString stringWithFormat:@"%ld", (long)_transferPeriods] forKey:@"transferPeriods"];
...
-(void)didChangeComboBoxValue:(AJComboBox *)comboBox selectedIndex:(NSInteger)selectedIndex
{
    switch (comboBox.tag) {
        case 0:
        {
            switch (selectedIndex) {
                case 0:
                {
                    ...
                    _dateBox.frame = CGRectMake(80, 143, 100, 28);
                    _reasonLabel.frame = CGRectMake(10, 170, 120, 30);
                    _transferReason.frame = CGRectMake(10, 200, MSWIDTH-20, 70);
                    _SureBtn.frame = CGRectMake(self.view.frame.size.width*0.5-60, 285,120, 30);
                    _NameLabel.frame = CGRectMake(1000, 140, 150, 30);
                    ...
                    _infoTextView.frame = CGRectMake(10000, 205, MSWIDTH-20, 70);
                    _dateBox.table.frame= CGRectMake(_dateBox.frame.origin.x,_dateBox.frame.origin.y+28-_scrollView.contentOffset.y, _dateBox.frame.size.width, [[selectedArr objectAtIndex:1] count]*30);
                }
                    break;
                ...
                case 1:
                {
                    ...
                    _infoTextView.frame = CGRectMake(10, 205, MSWIDTH-20, 70);
                    
                    _DateLabel.frame = CGRectMake(10, 175, 120, 30);
                    _dateBox.frame = CGRectMake(80, 178, 100, 28);
                    _reasonLabel.frame = CGRectMake(10, 205, 120, 30);
                    _transferReason.frame = CGRectMake(10, 235, MSWIDTH-20, 70);
                    _SureBtn.frame = CGRectMake(self.view.frame.size.width * 0.5 - 60, 320,120, 30);
                    _dateBox.table.frame= CGRectMake(_dateBox.frame.origin.x, _dateBox.frame.origin.y+28-_scrollView.contentOffset.y, _dateBox.frame.size.width, [[selectedArr objectAtIndex:1] count]*30);
                }
                    break;
            }
        ...
        case 1:
        {
            _transferPeriods = selectedIndex + 1;
...
-(void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    _comboBox.table.frame= CGRectMake(_comboBox.frame.origin.x, _comboBox.frame.origin.y+28-scrollView.contentOffset.y, _comboBox.frame.size.width, [[selectedArr objectAtIndex:0] count]*30);
    
    _dateBox.table.frame= CGRectMake(_dateBox.frame.origin.x, _dateBox.frame.origin.y+28-scrollView.contentOffset.y, _dateBox.frame.size.width, [[selectedArr objectAtIndex:1] count]*30);
