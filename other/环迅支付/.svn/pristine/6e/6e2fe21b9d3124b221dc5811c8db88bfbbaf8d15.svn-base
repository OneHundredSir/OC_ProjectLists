...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(5, 5, 190, 20)];
        _titleLabel.font = [UIFont boldSystemFontOfSize:14.0f];
        [self addSubview:_titleLabel];
        
        _stateImg = [[UIImageView alloc] initWithFrame:CGRectMake(198,5, 40, 20)];
        [self addSubview:_stateImg];
        
        _stateLabel = [[UILabel alloc] initWithFrame:CGRectMake(196,5, 40, 20)];
        ...
        _highestLabel = [[UILabel alloc] initWithFrame:CGRectMake(160,35, 150, 20)];
