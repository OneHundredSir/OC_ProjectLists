...
@property(nonatomic,assign)NSInteger statueNum;
...

{
    ...
    if (kind == UICollectionElementKindSectionHeader){
        ...
        headerView.btnLayer.position = CGPointMake(headerView.columBtn.center.x, headerView.columBtn.bounds.size.height-1);
