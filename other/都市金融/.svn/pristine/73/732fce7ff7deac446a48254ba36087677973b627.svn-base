...
- (void)initView
{
    ...
    UILabel *titlelabel1 = [[UILabel alloc] initWithFrame:CGRectMake(20, 80 -navBarH, 120, 30)];
    ...
    // 手机号码输入框
    _SafePhoneNumtextfield = [[UITextField alloc] initWithFrame:CGRectMake(20, 110 -navBarH, self.view.frame.size.width - 40, 40)];
    ...
    // 验证码输入框
    _Verifytextfield = [[UITextField alloc] initWithFrame:CGRectMake(20, 170 - navBarH, self.view.frame.size.width - 170, 35)];
    ...
    _verifyBtn.frame = CGRectMake(self.view.frame.size.width - 140, 170 -navBarH, 120, 35);
    ...
    ChangeBtn.frame = CGRectMake(10, 280 - navBarH, self.view.frame.size.width-20, 45);
