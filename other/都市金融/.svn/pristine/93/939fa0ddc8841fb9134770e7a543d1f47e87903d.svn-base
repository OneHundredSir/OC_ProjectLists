...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    }else if([bankNameStr rangeOfString:@"民生"].location !=NSNotFound)
    {
        cell.imageView.image = [UIImage imageNamed:@"BankcardIcon.bundle/CMBC"];
    }
    else if([bankNameStr rangeOfString:@"广发"].location !=NSNotFound)
    {
        cell.imageView.image = [UIImage imageNamed:@"BankcardIcon.bundle/GDB"];
    }
    else if([bankNameStr rangeOfString:@"邮政储蓄"].location !=NSNotFound)
    {
        cell.imageView.image = [UIImage imageNamed:@"BankcardIcon.bundle/PSBC"];
    }
    else if([bankNameStr rangeOfString:@"华夏银行"].location !=NSNotFound)
    {
        cell.imageView.image = [UIImage imageNamed:@"BankcardIcon.bundle/HXBANK"];
    }
    else
    {
