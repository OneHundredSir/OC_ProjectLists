...
//    expanBtn.frame = CGRectMake(self.view.frame.size.width-35, 35, 25, 20);
...
//    [expanBtn setTag:indexPath.section];
    [cell.expanBtn addTarget:self action:@selector(expanBtnClick:) forControlEvents:UIControlEventTouchUpInside];
//    [cell addSubviewexpanBtn];
