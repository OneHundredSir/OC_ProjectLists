...
- (void)initView
{
    ...
    UILabel *dataLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 30, 150, 30)];
    dataLabel.font = [UIFont boldSystemFontOfSize:13.0f];
    dataLabel.text = @"必审资料:";
    [_scrollView addSubview:dataLabel];
    
    _dataLabel1 = [[UILabel alloc] initWithFrame:CGRectMake(72, 30, self.view.frame.size.width - 92, 30)];
    ...
    _PromptLabel = [[UILabel alloc] initWithFrame:CGRectMake(8, 190, self.view.frame.size.width-10, 40)];
    ...
    _listView = [[UIFolderTableView alloc] initWithFrame:CGRectMake(0, 235, self.view.frame.size.width, 800)  style:UITableViewStyleGrouped];
...
-(void) httpResponseSuccess:(NetWorkClient *)client dataTask:(NSURLSessionDataTask *)task didSuccessWithObject:(id)obj
{
    ...
    if ([[NSString stringWithFormat:@"%@",[dics objectForKey:@"error"]] isEqualToString:@"-1"]) {
        ...
        DLOG(@"ti%@",_titleArr);
        UILabel *dataLabel11 = [[UILabel alloc] initWithFrame:CGRectMake(10, 110, 150, 30)];
        ...
        for (int i = 0; i < [_titleArr count]; i++) {
            ...
            if (i % 2 == 0) {
                dataLabel22.frame = CGRectMake(75, 110 + j * 20, 150, 30);
                j++;
            }else {
                dataLabel22.frame = CGRectMake(190, 110 + k * 20, 150, 30);
                k++;
            }
        ...
        if (_titleArr.count >8) {
            _scrollView.contentSize = CGSizeMake(MSWIDTH, 545+(_titleArr.count/2- 4)*20);
            _PromptLabel.frame = CGRectMake(8, 195+ (_titleArr.count/2- 4)*20, self.view.frame.size.width-10, 40);
            _listView.frame = CGRectMake(0, CGRectGetMaxY(_PromptLabel.frame)+10, self.view.frame.size.width, 800);
        }
