...
@interface LoginViewController ()<HTTPClientDelegate, QCheckBoxDelegate, UITextFieldDelegate>
{
    BOOL _isLoading;
    int curr;
}
...
- (void)initContentView
{
    ...
    if([[AppDefaultUtil sharedInstance]isRemeberUser] && _nameWindow.text.length != 0 && [[AppDefaultUtil sharedInstance] getDefaultUserPassword] != nil)
    {
