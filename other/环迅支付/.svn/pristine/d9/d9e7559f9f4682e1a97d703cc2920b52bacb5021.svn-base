...
//    menuArr = [[NSMutableArray alloc] init];
    ...
    IconDataArr = @[@"order_icon_001",@"order_icon_104",@"order_icon_204",@"nav_share",@"order_icon_206",@"Loan_mail",@"order_icon_201"];//,@"order_icon_205"
    _dataArr = @[@"账单",@"交易",@"债权转让",@"CPS推广",@"安全",@"站内信",@"资料"];//,@"银行卡"
