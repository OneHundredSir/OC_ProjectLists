...
//    [self initNavigationBar];
    ...
    CGFloat titleLabelY = 70 - 64;
    for (int i = 0; i<[infoArr count]; i++) {
        
        UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, titleLabelY+35*i, 100, 30)];
...
//            [idNo replaceCharactersInRange:NSMakeRange(12, 8) withString:@"********"];
        ...
        CGFloat titleLabelY = 70.f-64;
            for (int i = 0; i<[_dataArr count]; i++) {
                
                UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, titleLabelY+35*i, 250, 30)];
                titleLabel.font = [UIFont systemFontOfSize:14.0f];
                titleLabel.textAlignment = NSTextAlignmentLeft;
