...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(bean.isOverdue == Overdue_None){
        ...
        cell.repayView.frame = CGRectMake(CGRectGetMinX(cell.overdueView.frame) + 4, 30, 30, 20);
    }else {
         // 逾期
...
//    cell.moneyLabel.frame = CGRectMake(CGRectGetMaxX(cell.repayView.frame)+12, 30, 100, 20);
    ...
    cell.moneyLabel.text = [NSString stringWithFormat:@"%.2f元",bean.repaymentAmount];
