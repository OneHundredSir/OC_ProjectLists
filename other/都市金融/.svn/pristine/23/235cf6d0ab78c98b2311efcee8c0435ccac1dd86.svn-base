...
//
    ...
    _reasonView  = [[UITextView alloc]  initWithFrame:CGRectMake(10, titleLabelY+30, self.view.frame.size.width-20, 100)];
    ...
    reportBtn.frame = CGRectMake(self.view.frame.size.width*0.5-70, titleLabelY+30 + 140,140, 40);
