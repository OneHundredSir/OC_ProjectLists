...
- (void)initData
{
    _titleArrays = @[@"打赏好评",@"关注官方微信",@"拨打客服电话",@"了解我们",@"退出帐号"];
...
{
    UIView *backView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, MSWIDTH, 280)];
...
//    [backView addSubview:titleLabel];
    ...
    imageView.frame = CGRectMake(MSWIDTH*0.5 - 40, 100, 80, 80);
    imageView.image = [UIImage imageNamed:@"logo"];
//    imageView.layer.cornerRadius = 36;
//    imageView.clipsToBounds = YES;
//    imageView.layer.borderWidth = 2;
//    imageView.layer.borderColor = [UIColor clearColor].CGColor;//KColor.CGColor;
//    imageView.contentMode = UIViewContentModeScaleAspectFit;
    ...
    _moreTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 280, self.view.frame.size.width, 220) style:UITableViewStyleGrouped];
...
//            [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"itms:appstore地址"]];
        ...
        case 1:
        {
            UIAlertView *alertView = [[UIAlertView alloc]initWithTitle:@"" message:[NSString stringWithFormat:@"公众号已复制到剪贴板,你可以微信-通讯录-搜索框粘贴\"%@\"公众号,点击关注即可.",_detailTextArr.count?_detailTextArr[1]:@"" ] delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"去关注", nil];
            alertView.tag = 11;
            [alertView show];
        ...
        case 2:
        {
            UIAlertView *alertView1 = [[UIAlertView alloc] initWithTitle:_detailTextArr.count?_detailTextArr[2]:@"" message:@"服务时间: 8:00 - 20:00" delegate:self cancelButtonTitle:@"取消"otherButtonTitles:@"拨打", nil];
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    if (buttonIndex == 1) {
        if (alertView.tag == 10)
        {
            NSString *phoneNum = [_detailTextArr[2] stringByReplacingOccurrencesOfString:@"-" withString:@""];
        ...
        }else if (alertView.tag == 11)
        {
            ...
            pasteboard.string = _detailTextArr.count?_detailTextArr[1]:@"";
