...
//    [self initNavigationBar];
    ...
    CGFloat _fundRecordView1Y = transferBtnY + 40;
    _fundRecordView1 = [[FundRecordViewController alloc] init];
    _fundRecordView1.purposeStr = @"6";
    _fundRecordView1.view.frame = CGRectMake(0, _fundRecordView1Y, self.view.frame.size.width, self.view.frame.size.height);
    ...
    _fundRecordView2.view.frame = CGRectMake(0, _fundRecordView1Y, self.view.frame.size.width, self.view.frame.size.height);
