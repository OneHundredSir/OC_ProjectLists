...
- (void)initDate
{
    ...
    _investNum = 0;
    _activityNum = 0;
    _titleArrays = @[@"推送设置",@"理财满标提醒",@"账单提醒",@"活动"];
    _allsetStr = @"";
    _selectStr1 = @"1";
    _selectStr2 = @"1";
    _selectStr3 = @"1";
...
- (void)changeOnOff
{
    ...
    UITableViewCell *cell11 = (UITableViewCell *)[_settingTableView viewWithTag:100];
    ...
    UISwitch *switchON11  = (UISwitch*)[cell11.contentView viewWithTag:100];
    ...
    if (_investNum ==1 && _billNum ==1 && _activityNum ==1) {
        
       [switchON11 setOn:YES];
    }else{
...
{
  NSString *settingcell = [NSString stringWithFormat:@"settingCell%ld",(long)indexPath.section] ;
    ...
    switchON.tag = indexPath.section + 100;
...
- (void)switchAction:(UISwitch *)switchV
{
    ...
    if ([_selectStr1 isEqualToString:@"1"]&&[_selectStr2 isEqualToString:@"1"]&&[_selectStr3 isEqualToString:@"1"]) {
        [switchON11 setOn:YES animated:YES];
    }
