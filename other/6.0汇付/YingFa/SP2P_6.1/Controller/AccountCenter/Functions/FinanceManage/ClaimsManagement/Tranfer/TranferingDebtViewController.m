...
- (void)initView
{
    ...
    _dealBtn.backgroundColor = GreenColor;
...
- (void)dealBtnClick:(UIButton *)btn
{
    ...
    if (dealStatu) {
        ...
        UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"确认成交" message:str delegate:self cancelButtonTitle:@"确定" otherButtonTitles:@"退出", nil];
