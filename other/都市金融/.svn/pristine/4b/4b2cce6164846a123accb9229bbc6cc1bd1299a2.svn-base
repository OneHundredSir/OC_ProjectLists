...
//    menuArr = [[NSMutableArray alloc] init];
    ...
    IconDataArr = @[@"order_icon_001",@"order_icon_104",@"order_icon_205",@"order_icon_204",@"nav_share",@"order_icon_206",@"Loan_mail",@"order_icon_201"];
    _dataArr = @[@"账单",@"交易",@"银行卡",@"债权转让",@"CPS推广",@"安全",@"站内信",@"资料"];
}
...
- (void)initView
{
    ...
    CGFloat rowHeight = MSHIGHT > 568 ? 45:35;
...
-(void) httpResponseSuccess:(NetWorkClient *)client dataTask:(NSURLSessionDataTask *)task didSuccessWithObject:(id)obj
{
    ...
    if ([[NSString stringWithFormat:@"%@",[dics objectForKey:@"error"]] isEqualToString:@"-1"]) {
        ...
        UserInfo *usermodel = [[UserInfo alloc] initWithDict:obj];
