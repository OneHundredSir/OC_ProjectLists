...
//    NSLog(@"currentURL is %@",currentURL);
    ...
    //    [webView loadHTMLString:nil baseURL:nil];
        ...
        if ([[dict objectForKey:@"msg"] isEqualToString:@"返回页面成功！"]) {
...
//        BorrowingBillViewController *borrowingBill = [[BorrowingBillViewController alloc]init];
//        [self.navigationController popToViewController:borrowingBill animated:YES];
