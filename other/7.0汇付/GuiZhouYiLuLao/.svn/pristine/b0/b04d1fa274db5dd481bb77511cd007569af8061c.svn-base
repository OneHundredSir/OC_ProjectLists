...
//    [_listView headerBeginRefreshing];
    ...
    // 时间选择器背景View
    _timeView = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height, 320, 260)];
    ...
    yesBtn.backgroundColor = BrownColor;
    ...
    noBtn.backgroundColor = BrownColor;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    DLOG(@"状态：%d",withdrawMode.withdrawStatus);
