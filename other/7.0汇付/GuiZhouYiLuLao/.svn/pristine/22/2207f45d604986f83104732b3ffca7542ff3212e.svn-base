...
{
    UIView *backView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, MSWIDTH, 250)];
...
//    [backView addSubview:titleLabel];
    ...
    imageView.image = [UIImage imageNamed:@"logo"];
      imageView.frame = CGRectMake(MSWIDTH*0.5 - 45, 90, 75, 75);
    ...
    _moreTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 250, self.view.frame.size.width, 220) style:UITableViewStyleGrouped];
