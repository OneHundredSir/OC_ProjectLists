...
- (void)initView
{
    ...
    CGFloat titlelabel1Y = 80 - 64.f;
    UILabel *titlelabel1 = [[UILabel alloc] initWithFrame:CGRectMake(20, titlelabel1Y, 120, 30)];
    ...
    _emaillabel = [[UILabel alloc] initWithFrame:CGRectMake(50, titlelabel1Y + 40, 200, 30)];
    _emaillabel.text = @"";
    ...
    _statulabel = [[UILabel alloc] initWithFrame:CGRectMake(50, 170 - 64, 100, 30)];
    _statulabel.text = @"";
    ...
    _changeBtn.frame = CGRectMake(10, CGRectGetMaxY(_statulabel.frame) + 30, self.view.frame.size.width-20, 45);
