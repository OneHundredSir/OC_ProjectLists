...
#define kAlertHeight 190.0f// 对话框的高
...
- (void)show
{
    ...
    [self.alertnewPriceTF becomeFirstResponder];
}
...
- (void)willMoveToSuperview:(UIView *)newSuperview
{
    ...
    if (!self.backImageView) {
        ...
        [self.backImageView addTarget:self action:@selector(downKeyboard) forControlEvents:UIControlEventTouchDown];
    }
...
{
//    CGFloat fieldY =
    CGFloat offset = MSHIGHT - CGRectGetMaxY(self.leftBtn.frame) - self.frame.origin.y - 216 - 37;
    if (offset < 0) {
        [UIView animateWithDuration:0.25 animations:^{
