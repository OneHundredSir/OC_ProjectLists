...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (bean.status == -2||bean.status == -3||bean.status == -4||bean.status == -6) {
        ...
        cell.repayLabel.frame = CGRectMake(CGRectGetMaxX(cell.overdueView.frame) + 4, 30, 40, 20);
//        cell.moneyLabel.frame = CGRectMake(80, 32, 200, 20);
        ...
        cell.repayLabel.frame = CGRectMake(CGRectGetMaxX(cell.overdueView.frame), 32, 40, 20);
//        cell.moneyLabel.frame = CGRectMake(60, 32, 200, 20);
    ...
    {
        cell.repayLabel.text = @"已收款";
        cell.repayLabel.backgroundColor = [UIColor lightGrayColor];
        cell.userInteractionEnabled = YES;
        
    }else if(bean.status == -7){
        
        cell.repayLabel.text = @"已转让";
        cell.repayLabel.backgroundColor = [UIColor lightGrayColor];
        cell.userInteractionEnabled = NO;
    }else
    {
        cell.repayLabel.text = @"未收款";
        cell.repayLabel.backgroundColor = PinkColor;
        cell.userInteractionEnabled = YES;
    }
